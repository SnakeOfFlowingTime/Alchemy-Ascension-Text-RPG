...
'wooden sword' : Weapon(name = 'Wooden Sword', id = 'wooden sword', type = 'blunt', dmg = 2, value = 5, lvlreq = 0),

'weak bow' : Weapon(name = 'Weak Bow', id = 'weak bow', type = 'piercing', dmg = 2, value = 10, lvlreq = 1),

'rusty dagger' : Weapon(name = 'Rusty Dagger', id = 'rusty dagger', type = 'slashing', dmg = 1, value = 2, lvlreq = 0),

'acid body' : Weapon(name = 'Acidic Body', id = 'acid body', type = 'acid', dmg = 2, value = 0, lvlreq = 0),

'iron sword': Weapon(name = 'Iron Sword', id = 'iron sword', type = 'slashing', dmg = 4, value = 100, lvlreq = 3),
...
'heavy iron stick': Weapon(name = 'Heavy Iron Stick', id = 'heavy iron stick', type = 'blunt', dmg = 4, value = 120, lvlreq = 3),
...
'iron spear': Weapon(name = 'Iron Spear', id = 'iron spear', type = 'piercing', dmg = 4, value = 100, lvlreq = 3),
}